...
Updating version number and release date of the D64::Disk::Image package:
...
$command = sprintf q{sed -i -e "s/D64::Disk::Image Version [0-9]\\+\\.[0-9]\\+/D64::Disk::Image Version %s/" README}, $new_version;
